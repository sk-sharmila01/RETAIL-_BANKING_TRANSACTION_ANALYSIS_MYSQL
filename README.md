...
```
Retail-Banking-Transaction-Analysis-MySQL/
├── 01_sprint2 -create_database.sql                  # Database + table creation (DDL, PKs, FKs, constraints)
|
...
- LinkedIn: : www.linkedin.com/in/shaik-sharmila-a96347428

- GitHub: https://github.com/sk-sharmila01
